...
ssize_t plain_transfer_send( client_t *client,  void *buffer, size_t length);
...
ssize_t chunked_transfer_send( client_t *client,  void *buffer, size_t length);
...
ssize_t gzip_transfer_send( client_t *client,  void *buffer, size_t length);
